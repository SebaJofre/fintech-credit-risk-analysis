...
Para facilitar la toma de decisiones por parte del equipo directivo y permitir la exploración dinámica de estos indicadores, el siguiente paso del proyecto consiste en la construcción de un **Dashboard en Power BI** conectado a PostgreSQL.

### Objetivos de la Etapa de Power BI:
* **Conexión Directa:** Importación y modelado de datos desde la base de datos relacional.
